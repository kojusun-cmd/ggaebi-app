...
export const REGION_MAP_COPY = [
      { main: "🗼 서울특별시", subs: ["강남구", "서초구", "송파구", "마포구", "관악구", "영등포구", "강서구", "노원구", "용산구", "기타"] },
      { main: "🏡 경기도", subs: ["성남시", "수원시", "고양시", "용인시", "화성시", "부천시", "안산시", "남양주시", "안양시", "기타"] },
      { main: "🌆 인천광역시", subs: ["연수구", "남동구", "부평구", "서구", "미추홀구", "계양구", "중구", "기타"] },
      { main: "🌾 충청도", subs: ["천안시", "청주시", "아산시", "충주시", "제천시", "공주시", "서산시", "당진시", "보령시", "기타"] },
      { main: "⛰️ 강원특별자치도", subs: ["춘천시", "원주시", "강릉시", "속초시", "동해시", "평창군", "기타"] },
      { main: "🚄 대전광역시", subs: ["유성구", "서구", "중구", "동구", "대덕구", "기타"] },
      { main: "🏢 세종특별자치시", subs: ["전체", "고운동", "종촌동", "다정동", "새롬동", "도담동", "나성동", "기타"] },
      { main: "🍃 전라도", subs: ["전주시", "광주광역시", "익산시", "군산시", "순천시", "여수시", "목포시", "나주시", "기타"] },
      { main: "🌊 경상도", subs: ["창원시", "포항시", "구미시", "진주시", "김해시", "경주시", "안동시", "거제시", "대구광역시", "울산광역시", "기타"] },
      { main: "🚢 부산광역시", subs: ["해운대구", "수영구", "동래구", "부산진구", "남구", "사하구", "연제구", "북구", "기장군", "기타"] },
      { main: "🍊 제주특별자치도", subs: ["제주시", "서귀포시", "기타"] }
    ];
...
export const REGION_MAP = [
      {
        main: "🗼 서울특별시",
        subs: ["강남구", "서초구", "송파구", "마포구", "관악구", "영등포구", "강서구", "노원구", "용산구", "기타"]
      },
      {
        main: "🏡 경기도",
        subs: ["성남시", "수원시", "고양시", "용인시", "화성시", "부천시", "안산시", "남양주시", "안양시", "기타"]
      },
      {
        main: "🌆 인천광역시",
        subs: ["연수구", "남동구", "부평구", "서구", "미추홀구", "계양구", "중구", "기타"]
      },
      {
        main: "🌾 충청도",
        subs: ["천안시", "청주시", "아산시", "충주시", "제천시", "공주시", "서산시", "당진시", "보령시", "기타"]
      },
      {
        main: "⛰️ 강원특별자치도",
        subs: ["춘천시", "원주시", "강릉시", "속초시", "동해시", "평창군", "기타"]
      },
      {
        main: "🚄 대전광역시",
        subs: ["유성구", "서구", "중구", "동구", "대덕구", "기타"]
      },
      {
        main: "🏢 세종특별자치시",
        subs: ["전체", "고운동", "종촌동", "다정동", "새롬동", "도담동", "나성동", "기타"]
      },
      {
        main: "🍃 전라도",
        subs: ["전주시", "광주광역시", "익산시", "군산시", "순천시", "여수시", "목포시", "나주시", "기타"]
      },
      {
        main: "🌊 경상도",
        subs: ["창원시", "포항시", "구미시", "진주시", "김해시", "경주시", "안동시", "거제시", "대구광역시", "울산광역시", "기타"]
      },
      {
        main: "🚢 부산광역시",
        subs: ["해운대구", "수영구", "동래구", "부산진구", "남구", "사하구", "연제구", "북구", "기장군", "기타"]
      },
      {
        main: "🍊 제주특별자치도",
        subs: ["제주시", "서귀포시", "기타"]
