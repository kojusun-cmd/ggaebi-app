    ...
    <>
      ...
      {showChatModal && activeChatRoom && (
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(0,0,0,0.6)', zIndex: 999, display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ flex: 1, background: '#F8FAFC', padding: '14px', overflowY: 'auto' }}>
            {/* 기본 채팅 내역 */}
            ...
            <div style={{ display: 'flex', gap: '8px', marginBottom: '20px' }}>
              ...
              <div style={{ background: '#fff', padding: '12px 16px', borderRadius: '0 16px 16px 16px', border: '1px solid #E2E8F0', maxWidth: '82%', fontSize: '14px' }}>
            ...
            {chatStep === 1 && (
              <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: '20px' }}>
                <div style={{ background: '#10B981', color: '#fff', padding: '12px 16px', borderRadius: '16px 0 16px 16px', maxWidth: '82%', fontSize: '14px' }}>
      ...
      <nav className="bottom-nav" style={{ gridTemplateColumns: '60px 60px auto 60px 60px', justifyContent: 'center', columnGap: '6px', padding: '0' }}>
