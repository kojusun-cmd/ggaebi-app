...
export function BiddingPage({ onBack, onNavigate, initialTab }: { onBack: () => void, onNavigate: (page: string, item?: any) => void, initialTab?: string }) {
    ...
    return (
    <>
      <header className="top-header" style={{ backgroundColor: '#fff', zIndex: 50, borderBottom: 'none', paddingBottom: 0, paddingLeft: '14px' }}>
      ...
      >
        ...
        {activeTab === 'progress' && (
          <section style={{ marginTop: '18px' }}>
            <h2 style={{ fontSize: '18px', fontWeight: 'bold', marginBottom: '16px', display: 'flex', alignItems: 'center', gap: '4px', position: 'relative', left: '-25px' }}>
